  ...
  switch(PORTNAME)
   {
    case GPIO_PORTA: //Writing on the most significant 4 bits of PortA
     {
       GPIO_PORTA_DATA_R &= 0X0F;    //Anding with a mask of ones from bits 4 to 7
    ...
    {
      GPIO_PORTB_DATA_R &= 0X0F;    //Anding with a mask of ones from bits 4 to 7
    ...
    {
      GPIO_PORTC_DATA_R &= 0X0F;    //Anding with a mask of ones from bits 4 to 7
    ...
    {
      GPIO_PORTD_DATA_R &= 0X0F;    //Anding with a mask of ones from bits 4 to 7
    ...
    {
      GPIO_PORTE_DATA_R &= 0X0F;    //Anding with a mask of ones from bits 4 to 7
    ...
    {
      GPIO_PORTF_DATA_R &= 0X0F;    //Anding with a mask of ones from bits 4 to 7
...
void WRITE_LOW_NIPPLE(unsigned char PORTNAME, unsigned char VALUE)
{
  VALUE <<= 4;
   ...
   case GPIO_PORTA: //Writing on the least significant 4 bits of PortA
    {
      GPIO_PORTA_DATA_R &= 0XF0;    //Anding with a mask of ones from bits 0 to 3
	    GPIO_PORTA_DATA_R |= VALUE;  //ORing with the data value after shifting
    }
    break;
   ...
   case GPIO_PORTB: //Writing on the least significant 4 bits of PortB
    {
      GPIO_PORTB_DATA_R &= 0XF0;    //Anding with a mask of ones from bits 0 to 3
	    GPIO_PORTB_DATA_R |= VALUE;  //ORing with the data value after shifting
    }
    break;
    ...
    {
      GPIO_PORTC_DATA_R &= 0XF0;    //Anding with a mask of ones from bits 0 to 3
	    GPIO_PORTC_DATA_R |= VALUE;  //ORing with the data value after shifting
    }
    break;
    ...
    {
      GPIO_PORTD_DATA_R &= 0XF0;    //Anding with a mask of ones from bits 0 to 3
	    GPIO_PORTD_DATA_R |= VALUE;  //ORing with the data value after shifting
    }
    break;
   ...
   case GPIO_PORTE: //Writing on the least significant 4 bits of PortE
    {
      GPIO_PORTE_DATA_R &= 0XF0;    //Anding with a mask of ones from bits 0 to 3
	    GPIO_PORTE_DATA_R |= VALUE;  //ORing with the data value after shifting
    }
    break;
   ...
   case GPIO_PORTF: //Writing on the least significant 4 bits of PortF
    {
      GPIO_PORTF_DATA_R &= 0XF0;    //Anding with a mask of ones from bits 0 to 3
	    GPIO_PORTF_DATA_R |= VALUE;  //ORing with the data value after shifting
    }
    break;
   }
